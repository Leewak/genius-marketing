...
export const metadata: Metadata = {
  title:
    "Stratégie Marketing Digital à Marrakech – Plan Marketing & ROI | Genius Marketing",
  description:
    "Stratégie marketing digital sur mesure à Marrakech. Étude de marché, tunnel de conversion, plan marketing global pour maximiser votre croissance.",
  alternates: {
    canonical: "https://geniusmarketing.ma/services/strategie-marketing",
  },
};
...
const features = [
  {
    ...
    description:
      "Analyse concurrentielle, identification des opportunités et compréhension approfondie de votre marché cible au Maroc et à l'international.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Définition de votre proposition de valeur unique, votre persona client et votre positionnement différenciant sur le marché.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Conception et optimisation de votre entonnoir de vente complet : de la notoriété à la fidélisation, chaque étape est optimisée.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Stratégie marketing globale couvrant tous les canaux : digital, social media, content marketing, SEO, paid ads et relations presse.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Plan éditorial structuré, création de contenu à valeur ajoutée et stratégie de distribution pour attirer et engager votre audience.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Définition des indicateurs clés de performance, mise en place du tableau de bord et reporting mensuel détaillé pour piloter votre croissance.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
...
export default function StrategieMarketingPage() {
  return (
    <>
          ...
          <Breadcrumb
            items={[
              ...
              { name: "Services", url: "https://geniusmarketing.ma/services" },
              {
                ...
                url: "https://geniusmarketing.ma/services/strategie-marketing",
              },
            ]}
          />
          <div className="max-w-4xl">
            ...
            <AnimateOnScroll delay={0.2}>
              <p className="text-brand-gray text-xl leading-relaxed max-w-2xl mb-8">
                Une vision stratégique claire et un plan d&apos;action concret
                pour accélérer votre croissance et construire une marque forte
                sur le long terme.
              </p>
            </AnimateOnScroll>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimateOnScroll>
              ...
              <h2
                className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-bold text-brand-offwhite mb-6"
                style={{ fontFamily: "var(--font-syne)" }}
              >
                Ce que vous recevez
              ...
              <p className="text-brand-gray leading-relaxed">
                À l&apos;issue de notre mission stratégique, vous disposez
                d&apos;un arsenal complet de documents et outils pour piloter
                votre croissance en toute autonomie — ou avec notre
                accompagnement.
              </p>
            </AnimateOnScroll>
            <div>
                ...
                {deliverables.map((item, i) => (
                  <AnimateOnScroll key={item} delay={i * 0.06}>
                    <li className="flex items-center gap-4 p-4 rounded-xl border border-brand-border bg-brand-dark hover:border-brand-gold/20 transition-colors duration-200">
                      ...
                      <span className="text-brand-offwhite/80 text-sm">
                        {item}
                      </span>
                    </li>
                  </AnimateOnScroll>
      ...
      <OtherServices current="/services/strategie-marketing" />
      <CTASection />
    </>
  );
}
