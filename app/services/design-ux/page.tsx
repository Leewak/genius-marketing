...
export const metadata: Metadata = {
  title: "Design Web & UX Marrakech — UI Design, Wireframes, UX Research",
  description:
    "Design web et UX à Marrakech : UX Research, wireframes, UI design premium et prototypes. Des interfaces qui enchantent vos utilisateurs.",
  alternates: { canonical: "https://geniusmarketing.ma/services/design-ux" },
};

const features = [
  {
    title: "UX Research",
    description: "Analyse des comportements utilisateurs, interviews et tests d'usabilité pour concevoir des interfaces basées sur des données réelles.",
    icon: (
  ...
  },
  {
    ...
    description: "Maquettes interactives pour valider l'architecture et le flux utilisateur avant le développement. Itérations rapides et collaboration fluide.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Interfaces visuellement impactantes qui reflètent votre identité de marque. Typographie, couleurs et composants soigneusement pensés.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "Design System",
    description: "Bibliothèque de composants réutilisables pour une cohérence visuelle parfaite sur toutes vos plateformes digitales.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Des designs qui s'adaptent parfaitement à chaque écran. Mobile, tablette et desktop — une expérience cohérente partout.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Validation de vos interfaces par de vrais utilisateurs. Identification des points de friction et optimisation continue de l'expérience.",
    icon: (
      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="max-w-4xl">
            ...
            <AnimateOnScroll delay={0.1}>
              <h1 className="text-[clamp(2.5rem,6vw,5rem)] font-bold leading-tight tracking-tight text-brand-offwhite mb-6"
                style={{ fontFamily: "var(--font-syne)" }}>
                Design Web<br />
                <span className="text-brand-gold">& UX</span>
              </h1>
            </AnimateOnScroll>
            <AnimateOnScroll delay={0.2}>
              <p className="text-brand-gray text-xl leading-relaxed max-w-2xl mb-8">
                Des expériences digitales qui captivent, engagent et convertissent.
                Chaque interface est conçue avec soin pour vos utilisateurs.
              </p>
            </AnimateOnScroll>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <AnimateOnScroll>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center">
              {["Recherche", "Idéation", "Design", "Test", "Livraison"].map((phase, i) => (
                <div key={phase} className="flex items-center gap-4">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-brand-gold/10 border border-brand-gold/30 flex items-center justify-center text-brand-gold text-sm font-bold mb-2"
                      style={{ fontFamily: "var(--font-syne)" }}>
                      {i + 1}
                    </div>
                    <span className="text-brand-offwhite/70 text-sm font-medium">{phase}</span>
                  </div>
                  {i < 4 && (
          ...
          <div className="mb-14">
            <AnimateOnScroll>
              <h2 className="text-[clamp(1.8rem,3.5vw,2.8rem)] font-bold text-brand-offwhite mb-4"
                style={{ fontFamily: "var(--font-syne)" }}>
                Notre expertise<span className="text-brand-gold"> design.</span>
              </h2>
            </AnimateOnScroll>
          </div>
