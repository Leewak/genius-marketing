...
export const metadata: Metadata = {
  title:
    "Agence SEO à Marrakech – Référencement Google & Marketing Digital | Genius Marketing",
  description:
    "Agence SEO à Marrakech. Référencement naturel, Google Ads, Social Ads et analytics. Soyez visible là où vos clients vous cherchent.",
  alternates: {
    canonical: "https://geniusmarketing.ma/services/seo-marketing",
  },
};
...
const faqs = [
  {
    ...
    a: "Les premiers résultats apparaissent en 3 à 6 mois. Pour des résultats significatifs sur les mots-clés compétitifs, comptez 6 à 12 mois. Le SEO est un investissement long terme avec le meilleur ROI.",
  },
  {
    q: "Quelle est la différence entre SEO et Google Ads ?",
    a: "Le SEO génère du trafic organique gratuit sur le long terme. Google Ads génère du trafic payant immédiat. Les deux sont complémentaires pour une stratégie digitale complète.",
  },
  {
    q: "Travaillez-vous avec des entreprises hors de Marrakech ?",
    a: "Oui, nous accompagnons des clients dans tout le Maroc (Casablanca, Rabat, Agadir) et à l'international. Toute collaboration peut se faire à distance.",
  },
  {
    q: "Comment mesurez-vous les résultats SEO ?",
    a: "Nous fournissons des rapports mensuels avec : position sur Google, trafic organique, taux de conversion, appels et demandes générés.",
  },
];
...
const features = [
  {
    ...
    description:
      "Analyse approfondie de votre site : technique, contenu, backlinks. Identification des axes d'amélioration prioritaires.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Stratégie SEO complète : optimisation on-page, création de contenu, netlinking et suivi des positions sur Google.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Google Ads",
    description:
      "Campagnes Search, Display et Shopping ultra-ciblées. ROI maximisé grâce à une gestion experte de vos budgets publicitaires.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Social Ads",
    description:
      "Publicités Facebook, Instagram et TikTok. Ciblage précis, créatifs percutants et optimisation continue des performances.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Configuration de Google Analytics 4, Data Studio et suivi de conversions. Des données exploitables pour des décisions éclairées.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Newsletters, séquences automatisées et campagnes segmentées. Le canal le plus rentable pour fidéliser votre audience.",
    icon: (
      <svg
        className="w-6 h-6"
        viewBox="0 0 24 24"
...
export default function SeoMarketingPage() {
  return (
    <>
          ...
          <Breadcrumb
            items={[
              ...
              { name: "Services", url: "https://geniusmarketing.ma/services" },
              {
                ...
                url: "https://geniusmarketing.ma/services/seo-marketing",
              },
            ]}
          />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {results.map((r, i) => (
              <AnimateOnScroll key={r.label} delay={i * 0.08}>
                <div>
                  <div
                    className="text-3xl sm:text-4xl font-bold text-brand-gold mb-1"
                    style={{ fontFamily: "var(--font-syne)" }}
                  >
                    {r.metric}
                  </div>
      ...
      <OtherServices current="/services/seo-marketing" />
      <CTASection />
    </>
  );
}
